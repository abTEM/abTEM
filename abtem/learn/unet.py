...
#         self.conv1 = nn.Conv2d(in_channels=features, out_channels=features // 2, kernel_size=3)
#         self.pool2 = nn.MaxPool2d(kernel_size=2, stride=2)
#         self.conv2 = nn.Conv2d(in_channels=features // 2, out_channels=features // 4, kernel_size=3)
#         self.conv3 = nn.Conv2d(in_channels=features // 4, out_channels=self._nclasses, kernel_size=1)
#
#     def forward(self, x):
#         x = self.pool1(x)
#         x = self.conv1(x)
...
#         x = self.conv2(x)
#
#         return nn.Softmax2d()(self.conv3(x))
#
...
class UNetOld(nn.Module):
    ...
    def __init__(self, in_channels=1, classes=1, init_features=16, p=.3):
        ...
        self.dense_conv = nn.Conv2d(in_channels=features, out_channels=1, kernel_size=1)
    ...
    def forward(self, x):
        ...
        density = torch.sigmoid(self.dense_conv(dec1))
        classifiction = nn.Softmax2d()(self.class_conv(dec1))
        return density, classifiction
