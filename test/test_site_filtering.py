...
pytestmark = [
    ...
    # This test's cell is sized for a fast site-filtering check, not for
    # converged cross-sections, and sits below the inelastic delocalisation
    # margin for this edge. Same convention as test/test_ionization.py.
