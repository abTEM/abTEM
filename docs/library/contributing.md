...
There are many ways you can help the community to improve `abTEM`, some of the main ones are:
...
The documentation is build using [`jupyter-book`](https://jupyterbook.org/en/stable/intro.html).


Editing of the documentation happens in one of four places:

    First, the docstrings of the actual library live with the code and get hosted as part of the API reference
